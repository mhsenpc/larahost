...
class PathHelper
{
    public static function getProjectBaseDir(string $email, string $project_name) {
    ...
    public static function getDockerComposeDir(string $email, string $project_name) {
        return self::getProjectBaseDir($email, $project_name) . '/'.config('larahost.dir_names.docker-compose');
    }

    public static function getSourceDir(string $email, string $project_name) {
        return self::getProjectBaseDir($email, $project_name) . '/'.config('larahost.dir_names.source');
    }

    public static function getDeploymentLogsDir(string $email, string $project_name) {
        return self::getProjectBaseDir($email, $project_name) . '/'.config('larahost.dir_names.deployment_logs');
    }
